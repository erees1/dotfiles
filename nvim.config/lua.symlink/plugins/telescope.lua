...
vim.keymap.set("n", "<leader>os", require("telescope.builtin").lsp_dynamic_workspace_symbols, { desc = "Telescp[o]pe [S]ymbols" })
vim.keymap.set("n", "<leader>or", require("telescope.builtin").lsp_references, { desc = "Telescp[o]pe [S]ymbols" })
